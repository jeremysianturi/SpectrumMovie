    ...
    fun mapResponsetoEntities(input: List<DetailMovieResponse>): List<DetailMovieEntity> {
        ...
        input.map {
            val detailMovie = DetailMovieEntity(
                ...
                budget = it.budget,
                genresId = it.genres[0].id,
                genresName = it.genres[0].name,
                ...
                productionCompaniesId = it.productionCompanies[0].id,
                productionCompaniesLogoPath = it.productionCompanies[0].logoPath,
                productionCompaniesName = it.productionCompanies[0].name,
                productionCompaniesOriginCountry = it.productionCompanies[0].originCountry,
                productionCountriesIso_3166_1 = it.productionCountries[0].iso_3166_1,
                productionCountriesName = it.productionCountries[0].name,
                releaseDate = it.releaseDate,
                revenue = it.revenue,
                runtime = it.runtime,
                spokenLanguagesEnglishName = it.spokenLanguages[0].englishName,
                spokenLanguagesIso_639_1 = it.spokenLanguages[0].iso_639_1,
                spokenLanguagesName = it.spokenLanguages[0].name,
                status = it.status,
                tagline = it.tagline,
                title = it.title,
                video = it.video,
